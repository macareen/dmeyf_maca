...
lista<- c("ccajas_transacciones", "internet","callcenter_transacciones","catm_trx_other","ccaja_ahorro","ccaja_seguridad","ccajas_otras","ccajas_consultas","ccajas_depositos","ccajas_extracciones","ccajas_transacciones","ccajeros_propios_descuentos","ccheques_depositados","ccheques_depositados_rechazados","ccheques_emitidos","ccheques_emitidos_rechazados","ccuenta_corriente","cforex","cforex_buyelim","cforex_sell","cinversion1","cinversion2","cmobile_app_trx","comiciones_mantenimineto","cpagodeservicios","cpayroll2_trx","cplaz_fijo","cprestamos_hipotecarios","cprestamos_personales","cprestamos_prendarios","cprestamos_hipotecarios","cseguro_accidentes_personales","cseguro_auto","cseguro_vida","cseguro_vivienda","ctarjeta_debito","ctarjeta_master_debitos_automaticos","ctarjeta_master_descuentos","ctarjeta_visa","ctarjeta_visa_descuentos","master_cadelantos_efectivo","master_delinquency","master_Finiciomora","master_fultimocierre","master_fvencimiento","master_madelantos_dolares","master_madelantos_pesos","master_mcosnumo_dolares","master_mpagado","master_mpagos_dolares","master_status","matam_other","mcaja_ahorro_adicional","mcajeros_propios_descuentos","mcheques_depositados","mcheques_depositados_rechazados","mcheques_emitidos","mcheques_emitidos_rechazados","mcomiciones_mantenimiento","mcomiciones_otras","mcuenta_corriente_adicional","mdescubierto_preacordado","mforex_buy","mforex_sell","minversion1_dolares","minversion1_pesos","minversion2","mpagodeservicios","mpayroll2","mplazo_fijo_dolares","mplazo_fijo_pesos","mprestamos_personales","mprestamos_prendarios","mprestamos_hipotecarios","mtarjeta_master_debitos_automaticos","mtarjeta_master_descuentos","mtarjeta_visa_debitos_automaticos","mtarjeta_visa_descuentos","tcallcenter","tcuentas","thomebanking","tmobile_app","tpaquete1","tpaquete2","tpaquete3","tpaquete4","visa_cadelantos_efectivo","visa_delinquency","visa_fultimo_cierre","visa_fvencimiento","visa_madelantos_dolares","visa_madelantos_pesos","visa_mapgos_dolares","visa_mconsumo_dolares","visa_mpagado","visa_msaldo_dolares","visa_status")   #aqui van las columnas que se quieren eliminar

palancas$variablesdrift  <-unique(lista)
...
correr_todo  <- function( palancas )
{
        ...
        #dataset  <- fread( "./datasetsOri/paquete_premium.csv")
        ...
        cols_analiticas  <- setdiff( colnames(dataset),  c("numero_de_cliente","foto_mes","mes","clase_ternaria","cut_edad","cut_antiguedad","cut_rent","cut_rent_an","cut_cc","cut_ca","cut_consumo_t","cut_consumos","cut_comisiones","cut_atm") )
